...
namespace _14장_협정세계시와시간대
{
    class Program
    {
        ...
        class SampleCode
        {
            [ListNo("List 14-25 현지 시각과 대응되는 UTC를 구한다")]
            ...
            [ListNo("List 14-26 현지 시각에 대응되는 UTC를 얻을 수 있는지 확인")]
            ...
            [ListNo("List 14-27 문자열을 DateTimeOffset로 변환한다")]
            ...
            [ListNo("List 14-28 지정한 지역의 시간대를 구한다")]
            ...
            [ListNo("List 14-29 시간대의 목록을 구한다")]
            ...
            [ListNo("List 14-30 지정한 지역의 현재 시각을 구한다")]
            ...
            [ListNo("List 14-31 지정한 지역의 현재 시각을 구한다")]
            ...
            [ListNo("List 14-32 한국 시간을 다른 지역의 시간으로 변환한다")]
            ...
            [ListNo("List 14-33 A지역의 시각을 B지역의 시각으로 변환한다")]
