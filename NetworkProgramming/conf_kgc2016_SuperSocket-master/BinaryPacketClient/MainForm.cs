...
namespace BinaryPacketClient
{
    public partial class MainForm : Form
    {
        ...
        async void SendLogin(string echoMsg)
        {
            byte[] Body = Encoding.Unicode.GetBytes(echoMsg);

            List<byte> dataSource = new List<byte>();
            dataSource.AddRange(BitConverter.GetBytes((Int32)PACKETID.REQ_LOGIN));
            ...
            txtLogin.Text = string.Format("{0}: {1}", DateTime.Now, echoMsg);
        }
        ...
        {
            SendEcho("가나다라마바사아자차카파파타ㅣㄻ어린멍리ㅓㅁ닝러ㅣㅁㄴ아러ㅣ가나다라마바사아자차카파파타ㅣㄻ어린멍리ㅓㅁ닝러ㅣㅁㄴ아러ㅣ가나다라마바사아자차카파파타ㅣㄻ어린멍리ㅓㅁ닝러ㅣㅁㄴ아러ㅣ가나다라마바사아자차카파파타ㅣㄻ어린멍리ㅓㅁ닝러ㅣㅁㄴ아러ㅣ가나다라마바사아자차카파파타ㅣㄻ어린멍리ㅓㅁ닝러ㅣㅁㄴ>>");
